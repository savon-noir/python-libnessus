...
class NessusReportItem(object):
    ...
    def __repr__(self):
        """String representation of the object NessusReportItem
           TODO this could throw an exception as pluginid may not be here
    ...
    def __eq__(self, other):
        """Compare NessusReportItem with == operator
           :return: Return true if NessusReportItem are equal
           :rtype: Boolean
        """
        diff = DictDiffer(self.__vuln_info, other.__vuln_info)
        return (
    ...
    def __ne__(self, other):
        """Compare NessusReportItem with != operator
           ...
           :return: Return true if NessusReportItem are not equal
           :rtype: Boolean
        """
        diff = DictDiffer(self.__vuln_info, other.__vuln_info)
        return (
            isinstance(other, self.__class__)
            and len(diff.unchanged()) != len(self.__vuln_info)
            )
